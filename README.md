...
- Repository path: `username/daily_streak` (use this exact path in raw image URLs).
...
```md
![DailyStreaks](https://raw.githubusercontent.com/username/daily_streak/main/assets/github-streak.svg)
```
...
```bash
python3 src/daily_streak --username <> --output assets/github-streak.svg
```
